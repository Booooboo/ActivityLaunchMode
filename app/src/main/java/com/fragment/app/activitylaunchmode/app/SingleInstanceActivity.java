...
/**
 * Created by sunhongbo on 17/8/14.
 */
public class SingleInstanceActivity extends Activity {

    private static final String TAG = "bo/sinstanceactivity";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_singleinstance);
        mSingleInstance = (Button) findViewById(R.id.singleInstance);
        mTaskId = (TextView) findViewById(R.id.task_id);
        mTaskId.setText(String.format("task id is %s", this.getTaskId()));
        mSingleInstance.setOnClickListener(new OnClickListener() {
            @Override
